...
wp --allow-root plugin install tinymce-advanced --activate
wp --allow-root plugin install duplicate-post --activate
wp --allow-root plugin install wp-pagenavi --activate
wp --allow-root plugin install custom-post-type-ui --activate
wp --allow-root plugin install really-simple-ssl --activate
wp --allow-root plugin install safe-svg --activate
